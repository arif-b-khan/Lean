...
**Tests**: Automated tests are REQUIRED for production code changes. Include unit,
integration, and regression tests as appropriate to the scope and risk of each story.
...
- [ ] T010 [P] Define secret handling strategy (env vars/secret store) and remove hardcoded credentials from tracked config
...
### Tests for User Story 1 (REQUIRED for production changes) ⚠️
...
### Tests for User Story 2 (REQUIRED for production changes) ⚠️
...
### Tests for User Story 3 (REQUIRED for production changes) ⚠️
...
- [ ] TXXX [P] Run secret scanning and verify no credentials are committed in source or tracked configuration
